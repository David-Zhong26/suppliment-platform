            ...
            <div
              ...
              className={`transition-all duration-500 ease-in-out ${
                position === 'current'
                  ...
                  : position === 'prev'
                  ? 'transform scale-85 -translate-x-12 z-10 opacity-70'
                  : 'transform scale-85 translate-x-12 z-10 opacity-70'
              }`}
            >
              <Card className={`bg-white border-2 rounded-2xl shadow-lg transition-all duration-500 ${
                ...
                <CardHeader className={`pb-3 ${position === 'current' ? 'p-5' : 'p-4'}`}>
                  {/* Match Score Badge */}
                  ...
                  <div className="text-center mb-4">
                    <div className={`bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-2 ${
                      position === 'current' ? 'w-16 h-16' : 'w-12 h-12'
                    }`}>
                      {product.icon}
                    </div>
                ...
                <CardContent className={`pt-0 ${position === 'current' ? 'p-5 pt-0' : 'p-4 pt-0'}`}>
                  {/* Trust Notes */}
                  <div className="mb-3">
                  ...
                  <div className="space-y-2">
                    <Button
                      ...
                      className={`w-full btn-primary-wellness hover:bg-[#15803d] text-sm ${
                    ...
                    <Button
                      variant="outline"
                      className={`w-full text-xs border-[#16A34A] text-[#16A34A] hover:bg-[#16A34A] hover:text-white ${
                        position === 'current' ? 'py-2' : 'py-1'
                      }`}
